...
The file "supersinglets_new.ipynb" shows the performance of the proposed method in the noiseless case for arbitrary system size.

The file "noisy_case_4.ipynb" and "noisy_case_6.ipynb" shows the performance of the proposed method in the noisy case for system size N=4 and N=6.
